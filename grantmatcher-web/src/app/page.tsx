...
export default function Home() {
  ...
  useEffect(() => {
    if (status === 'authenticated') {
      ...
      // For now, redirect to dashboard (we'll add profile check later)
    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600 font-medium">Loading GrantMatcherAI...</p>
        </div>
      </div>
    );
  }
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24 sm:py-32">
          <div className="text-center">
            ...
            <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-8 leading-tight">
              Find Grants That
              <span className="bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent"> Match Your Mission</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              <Link
                href="/login"
                className="group relative px-8 py-4 bg-gradient-to-r from-blue-600 to-purple-600 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transform hover:scale-105 transition-all duration-200"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Get personalized grant matches in minutes, not months
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-12">
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">2. AI Matching</h3>
              <p className="text-gray-600 text-lg leading-relaxed">
                Our advanced AI analyzes thousands of federal grants, comparing your profile with grant requirements, eligibility criteria, and funding priorities.
              </p>
            </div>
            ...
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-semibold text-gray-900 mb-4">3. Apply with Confidence</h3>
              <p className="text-gray-600 text-lg leading-relaxed">
                Get detailed grant information, eligibility guidance, and application tips. Track your applications and never miss a deadline.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            <div className="text-center">
              ...
              <div className="text-gray-600">Grants Indexed</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-gray-600">Funding Connected</div>
            </div>
            <div className="text-center">
      ...
      <section className="py-24 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Join thousands of organizations already using GrantMatcherAI to secure funding for their missions.
          </p>
          <Link
            href="/login"
